  ...
  return (
    <form onSubmit={handleSubmit}>
      <Box display="flex" flexDirection="column" justifyContent={"center"} maxWidth={700} alignContent={"center"} alignSelf="center" marginLeft={"auto"} marginRight="auto" marginTop={10} >
        ...
        <TextField value={inputs.tier} onChange={handleChange} type="number" margin="normal" fullWidth variant="outlined" name="tier" />
        ...
        <Button color="warning" variant="contained" type="submit"> Add Book </Button>
      </Box>
    </form>
  );
};
